...
export function createVideoChatResponseInstructions(
  ...
  return [
    ...
    `Brief: {"type":"answer","intent":"explanation|practical|story|comedy|imagination","visualStyle":"realistic|illustrated","musicMood":"calm|focused|upbeat|off","opening":"useful spoken line","subject":"literal subject","development":"short outline of essential points that fit the available beats, or empty when ending alone suffices","visualDirection":"consistent subjects, appearance and setting within the selected style"}.`,
    ...
    "Choose one visualStyle for the whole answer, including its ending: realistic or illustrated. DEFAULT TO REALISTIC: photographic live-action with cinematic framing, believable materials, light and physical movement. Choose from the planned visible subjects, not whether the question is hypothetical, scientific, fictional or emotional. People, animals, objects and places should look photographed even in imagined or counterfactual situations; an event need not have happened to be depicted photographically. Narration can explain an invisible cause over its visible effect or a relevant human experience. Select illustrated only when the user requests drawn animation or the answer needs a schematic view of structures, relationships or processes that filmed subjects cannot communicate. Illustrated means clearly drawn 2D ink-and-paper animation with flat colour. The selected treatment defines the rendering medium: visualDirection and shot actions supply compatible subject, setting and framing details, never a conflicting medium. CALLER VISUAL DIRECTION overrides automatic choices; keep all descriptions compatible with it without overriding grounding or the output contract. Illustrations and generated footage support an explanation; they are not evidence.",
