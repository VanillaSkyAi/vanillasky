...
import { CLIP_NARRATION_TAIL_SEC, clipNarrationBudget } from "../protocol/clip-budget.js";
...
export function createVideoChatResponseInstructions(
 ...
 return [
  ...
  limited
    ...
    : "Keep each spoken beat concise within the overall answer duration. Stock footage is checked after selection against its available duration, not a generated-video vendor's clip setting. Missing or insufficient footage becomes a chapter with complete narration.",
