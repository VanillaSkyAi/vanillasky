...
export function createVideoChatResponseInstructions(
  ...
  return [
    ...
    "Choose visualStyle: explanation defaults to illustrated, practical to realistic, story/comedy/imagination to cinematic. Explicit visual requests may choose any style. CALLER VISUAL DIRECTION overrides automatic choices; visualDirection must be compatible, without overriding grounding or the output contract. Keep one coherent direction through the ending. Illustrations and generated footage support an explanation; they are not evidence.",
