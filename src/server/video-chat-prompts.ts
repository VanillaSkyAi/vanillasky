...
export function createVideoChatResponseInstructions(
 ...
 return [
  ...
  ...(mode === "pexels" ? ["Choose a separate stock subject for each beat, describing footage that can realistically exist in a stock library. For historical, abstract or unseen events, use relevant present-day evidence, objects, environments or analogous visible processes as clearly illustrative support. For dinosaur extinction, museum skeletons or fossils can support the evidence, a forest can illustrate affected ecosystems, and modern birds can accompany the surviving lineage. Do not ask stock footage to show a literal prehistoric impact or living extinct animal. Keep the causal explanation in narration; do not claim illustrative footage records the historical event or proves the mechanism. Make stockSelection describe the chosen visible subject, not the overall topic. Do not use illustrative freedom to replace a required practical action, person, sport or distinguishing equipment with unrelated scenery."] : []),
