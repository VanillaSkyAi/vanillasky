...
export async function* plannerStream() {
  ...
  yield JSON.stringify({ type: "answer", intent: "explanation", opening: "The Moon turns with its orbit", subject: "moon", development: "Rotation and orbit stay in step.", ending: shot("Rotation and orbit stay in step.") }) + "\n";
